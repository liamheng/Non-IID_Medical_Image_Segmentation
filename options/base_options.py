...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--no_flip', action='store_true', help='if specified, do not flip the images for data augmentations')
        ...
        parser.add_argument('--time_prefix', action='store_true', help='if time_suffix is set and suffix is empty, the suffix will be set to timestamp.')
    ...
    def parse(self):
        ...
        if opt.time_prefix and opt.suffix == '':
            opt.suffix = time.strftime("%Y-%m-%d_%H:%M", time.localtime())
